...
[![Build Status](https://travis-ci.org/UMM-CSci-3601-S19/lab-2-lab-2-client-server-architecture.svg?branch=master)](https://travis-ci.org/UMM-CSci-3601-S19/lab-2-lab-2-client-server-architecture)
